...
// Обработчик событий для кнопки "Мои отели"
...
// Обработчик событий для кнопки "Добавить отель"
var addMyHotelButton = document.getElementById("add-my-hotel");
if (addMyHotelButton != null) {
    // Добавляем обработчик события клика
    addMyHotelButton.addEventListener("click", function () {
        // Переходим на главную страницу
        window.location.href = "/BookingSystem_war/create-hotel";
    });
}
